...
export function Onboarding() {
	...
	const getStepTitle = () => {
		switch (step) {
			case 0:
				return "Welcome to VibeGen AI Beta! 🎉";
			case 1:
				return "⚠️ This is a super early beta!";
			case 2:
				return "🦋 Have fun testing!";
			default:
				return "VibeGen AI Onboarding";
		}
	};
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to VibeGen AI Beta! 🎉" />
							<Description description="You're among the first to try VibeGen AI - the AI video creation and editing workspace." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							...
							<Description description="If you're curious, check out our roadmap [here](https://vibegen.ai/roadmap)" />
						</div>
						<NextButton onClick={handleNext}>Next</NextButton>
					</div>
				);
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Join our [Discord](${SOCIAL_LINKS.discord}), chat with cool people and share feedback to help make VibeGen AI better.`}
							/>
						</div>
