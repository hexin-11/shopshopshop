...
export default function AgentDock({ children }: AgentDockProps) {
  ...
  // Handle shopclip:openVideoCreation event
  useEffect(() => {
    ...
    window.addEventListener("shopclip:openVideoCreation", handler);
    return () => window.removeEventListener("shopclip:openVideoCreation", handler);
  }, []);
